const model = (() => {
    const episodes = [
        ...
        },
        {
            ...
            bonusContent: [
                {
                    bonusCategory: "Shooting Episode Two",
                },
                {
        ...
        },
        {
            ...
            bonusContent: [
                {
                    bonusCategory: "Shooting Episode Three",
                },
                {
                    bonusDesc: "Our friend Maddie made us the beautiful Weasley jumper for this episode. Watch out for her cameo in episode 6 ;)",
                    classes: ["bonus-grid"],
                    links: [
                        "../images/ep_3/e03_m01_jumpercycle.jpg",
                        "../images/ep_3/e03_m02_jumperfinished.jpg",
                    ]
                },
                {
                    bonusDesc: "Here's a good view of the back side of the window:",
                    classes: ["big"],
                    links: [
                        "../images/ep_3/e03_m03_bts.jpg",
                    ]
                }
            ]
        },
        {
            ...
            bonusContent: [
                ...
                {
                    bonusDesc: "Janet's main audition tape was from the end of episode 4",
                    links: [
                        "https://www.youtube.com/embed/RF19UAI2JH4",
                    ]
                },
                {
                    bonusCategory: "The Three Brothers",
                },
                {
                    bonusDesc: "Like much of this series, the Three Brother’s animation gag began as a delirious joke that somehow resulted in countless hours of grueling work. Cutler built the characters and animated them onto the original shot.",
                    links: [
                        "https://www.youtube.com/embed/jA8fsEyG6Mo",
                    ]
                },
                {
                    bonusDesc: "Cutler tried a lot of different things to get the look of Death right, like these different approaches to the arms and hands.",
                    classes: ["bonus-grid"],
                    links: [
                        "../images/ep_4/e04_m03_deathhands.jpg",
                        "../images/ep_4/e04_m04_deatharms.jpg",
                    ]
                }
            ]
        },
        {
            ...
            bonusContent: [
                ...
                {
                    bonusDesc: "Lindsey's audition tape for Ginny:",
                    links: [
                        "https://www.youtube.com/embed/yfOgWoZl78s",
                    ]
                },
                {
                    bonusCategory: "Pregnant Belly",
                },
                {
                    bonusDesc: "We created Ginny's fake baby bump by wrapping a bicycle helmet in a pillowcase and stuffing it under her shirt.  Yes, we know it could look better.",
                    links: []
                }
            ]
        },
        {
            ...
            bonusContent: [
                {
                    bonusCategory: "Doubling Harry",
                },
                {
                    bonusDesc: "Harry had to appear twice in the pensieve scene, and we used a combination of body doubles and digital compositing to create the effect.",
                    links: [
                        "https://www.youtube.com/embed/Qjt8G2Q9O5c",
                    ]
                },
                {
                    bonusCategory: "Creating Hogwarts",
                },
                {
                    bonusDesc: "We knew creating a realistic Headmaster’s office on our budget was out of the question, so we tried to think of an abstract approach to the set. A black infinity background would allow us to shoot the scene in our apartment. Dumbledore’s portrait hung where the window usually went above the therapy couch.",
                    classes: ["big"],
                    links: [
                        "../images/ep_6/e06_m01_hogwartssetwide.jpg",
                        "../images/ep_6/e06_m02_normalset.jpg",
                    ]
                },
                {
                    bonusDesc: "The minimalistic set was meant to evoke theater design, and in that spirit we avoided using digital effects.",
                    classes: ["big"],
                    links: [
                        "../images/ep_6/e06_m04_maddie.jpg",
                        "../images/ep_6/e06_m03_bts1.jpg",
                    ]
                },
                {
                    bonusDesc: "Here’s a test of Dumbledore’s beard, which Cutler created for himself:",
                    links: [
                        "../images/ep_6/e06_m15_beardtest.jpg",
                    ]
                },
                {
                    bonusDesc: "Instead of compositing footage of Dumbledore onto a flat surface, we put him in a box with a picture frame.",
                    links: [
                        "../images/ep_6/e06_m05_dumbledoreselfie.jpg",
                    ]
                },
                {
                    bonusDesc: "To give the painting a flat texture and to soften his image, we put thin fabric inside the portrait frame. This is an early test as we experimented with different fabrics:",
                    classes: ["big"],
                    links: [
                        "../images/ep_6/e06_m06_portraittest.jpg",
                    ]
                },
                {
                    bonusDesc: "The gothic windows were the first set pieces constructed.",
                    classes: ["bonus-grid"],
                    links: [
                        "../images/ep_6/e06_m10_windowconcept1.jpg",
                        "../images/ep_6/e06_m11_windowconcept2.jpg",
                        "../images/ep_6/e06_m12_windowconstruction1.jpg",
                        "../images/ep_6/e06_m13_windowconstruction2.jpg",
                    ]
                },
                {
                    bonusDesc: "The fireplace was the most elaborte piece of set construction.  Cutler still isn't sure how Tyler pulled it off.",
                    classes: ["bonus-grid"],
                    links: [
                        "../images/ep_6/e06_m07_fireplaceconcept1.jpg",
                        "../images/ep_6/e06_m08_fireplaceconcept2.jpg",
                        "../images/ep_6/e06_m09_portraitconstruction.jpg",
                    ]
                },
                {
                    bonusDesc: "For the portraits of previous headmasters, Cutler found old paintings of people who looked especially witchy or wizardly.",
                    classes: ["big"],
                    links: [
                        "../images/ep_6/e06_m14_portraits.png",
                    ]
                },
                {
                    bonusCategory: "Bringing It All Together",
                },
                {
                    bonusDesc: "It took a lot of work to build the set and costumes on such a low budget, but in the end it was our careful attention to the cinematography that made everything work. The stylized lighting, the handheld camerawork, and the black-and-white, grainy color grade all give the scene a dream-like quality that made up for the fact that the production design wasn’t exactly blockbuster-quality. Here is a comparison of raw footage to the final product:",
                    links: [
                        "https://www.youtube.com/embed/jKBzOJO80zc",
                    ]
                },
                {
                    bonusCategory: "Using the Pensieve",
                },
                {
                    bonusDesc: "We were excited to finally get to show off Tyler’s pensieve prop in this episode!",
                    classes: ["big"],
                    links: [
                        "../images/ep_6/e06_m16_pensievebts.jpg",
                    ]
                }
            ]
        },
        {
            ...
            bonusContent: [
                {
                    bonusCategory: "The Daily Prophet",
                },
                {
                    bonusDesc: "Tyler designed the daily prophet cover. He wrote the actual articles!",
                    classes: ["big"],
                    links: [
                        "../images/ep_7/e07_m01_newspaper.jpg",
                    ]
                },
                {
                    bonusCategory: "Muggle Husband",
                },
                {
                    bonusDesc: "We’d planted hints that Aquila’s husband was a muggle throughout the series, but if you’re as oblivious as Harry, you might not have picked up on them. The man in the photo is actress Janet’s real-life husband, who you also might recognize as our Slughorn!",
                    classes: ["bonus-grid"],
                    links: [
                        "../images/ep_7/e07_m02_mugglephoto.jpg",
                        "../images/ep_7/e07_m03_slughorn.jpg",
                    ]
                },
                {
                    bonusCategory: "Harry's Costume",
                },
                {
                    bonusDesc: "We found this shirt online and though it was adorable to imagine that someone from his team would make this shirt and that he’d still wear it.",
                    links: [
                        "../images/ep_7/e07_m04_shirt.jpg",
                    ]
                },
                {
                    bonusCategory: "Aquila's Notes",
                },
                {
                    bonusDesc: "Here's a peek at Aquila's notes for Harry and Draco's sessions:",
                    links: [
                        "../images/ep_7/e07_m05_harrynotes.jpg",
                        "../images/ep_7/e07_m06_draconotes.jpg",
                    ]
                },
                {
                    bonusCategory: "The Final Shot",
                },
                {
                    bonusDesc: "We finished Draco’s scene after Bryce and Janet left with the most barebones of skeleton crews.",
                    classes: ["big"],
                    links: [
                        "../images/ep_7/e07_m07_finalshot.jpg",
                    ]
                }
            ]
        },
                ...
                if (!bonus.bonusDesc) {
                    ...
                    bonus.links.forEach(link => {
                        ...
                        if (link.includes("png")) {
                            bonusItem.classList.add("bonus-no-frame");
                        }
                        if (bonus.classes) {
